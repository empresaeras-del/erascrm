...
//
// Why the `erascrm_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     an erascrm key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for an `erascrm_test_` variant
...
export const API_KEY_PREFIX = 'erascrm_live_';
